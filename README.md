...
> Calculate the [standard deviation][standard-deviation] of an array using Welford's algorithm.
...
```javascript
import stdevwd from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-array-stdevwd@esm/index.mjs';
```
The previous example will load the latest bundled code from the esm branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-array-stdevwd/tags). For example,

```javascript
import stdevwd from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-array-stdevwd@v0.1.0-esm/index.mjs';
```

#### stdevwd( x\[, correction] )

Computes the [standard deviation][standard-deviation] of an array using Welford's algorithm.
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-array-stdevwd.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-array-stdevwd

[test-image]: https://github.com/stdlib-js/stats-array-stdevwd/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-array-stdevwd/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-array-stdevwd/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-array-stdevwd?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-array-stdevwd.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-array-stdevwd/main
...
[branches-url]: https://github.com/stdlib-js/stats-array-stdevwd/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-array-stdevwd/main/LICENSE
